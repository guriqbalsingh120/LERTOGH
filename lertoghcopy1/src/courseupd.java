...
public class courseupd extends HttpServlet {
		...
		doGet(request, response);
		 ...
		 response.setContentType("text/html;charset=UTF-8");
	        ...
	        try {
	            ...
	            cn.ps = connection.myconn().prepareStatement("update course set title=?,content=?,dt=?,logo=?,savepath=?,fees=?,ctime=?,clink=?,cdate=?,drive=? where id=?");
